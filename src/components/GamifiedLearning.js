...
// Import advanced games
import WordChain from '../games/WordChain';
import SentenceBuilder from '../games/SentenceBuilder';

const GamifiedLearning = React.memo(({ userStats, isDarkMode, words, onWordStatUpdate, onLessonComplete }) => {
  ...
  const renderSelectedGame = () => {
    ...
    const gameProps = {
      words: words || [],
      onWordStatUpdate: onWordStatUpdate,
      onLessonComplete: handleGameComplete,
    ...
    switch (selectedGame.id) {
      ...
      case 'sentence-builder':
        return <SentenceBuilder {...gameProps} />;
      default:
        return (
          <div style={{
            padding: '2rem',
