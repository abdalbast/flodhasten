...
import { MdFlip, MdCompareArrows, MdSpellcheck, MdQuiz, MdVolumeUp, MdHighlightOff, MdKeyboardArrowDown, MdGamepad, MdSportsKabaddi } from 'react-icons/md';
  ...
  return (
    <div style={{
      ...
      <div style={{display:'flex',flexDirection:'column',gap:16,marginTop:20}}>
        ...
        <button onClick={()=>setGame('mario')} style={{
          background:'#1565c0',
          color:'#fff',
          border:'none',
          borderRadius:8,
        ...
        ><MdSportsKabaddi style={{verticalAlign:'middle',marginRight:6}}/>Mario Language</button>
      </div>
    </div>
  );
}
