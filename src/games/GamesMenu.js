...
import { MdFlip, MdCompareArrows, MdSpellcheck, MdQuiz, MdVolumeUp, MdHighlightOff, MdKeyboardArrowDown, MdGamepad, MdRocketLaunch } from 'react-icons/md';
  ...
  return (
    <div style={{
      ...
      <div style={{display:'flex',flexDirection:'column',gap:16,marginTop:20}}>
        ...
        <button onClick={()=>setGame('spaceinvaders')} style={{
          background:'#1e88e5',
          color:'#fff',
          border:'none',
          borderRadius:8,
        ...
        ><MdRocketLaunch style={{verticalAlign:'middle',marginRight:6}}/>Space Invaders: Swedish</button>
      </div>
    </div>
  );
}
